...
if(isset($_SESSION) && isset($_SESSION['email']) && isset($_SESSION['password']))
{
    ...
    if($userExist == 1)
    {
        ...
        {
        require __DIR__.'/../../Controller/Frontend/'. $direction .'Controller.php';
        }
    }
    else
    {   
        ...
        ?>
        <?php
            include('Web/inc/unauthorisedAdminPage/redirectionPublic.php'); 
        ?>
        <?php
    }
}
else
{
    ?>
    <?php
        include('Web/inc/unauthorisedPage/redirectionPublic.php'); 
    ?>
    <?php
}
?>
